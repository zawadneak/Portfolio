...
export default function Footer({ absolute }) {
  ...
  if (absolute) {
    containerStyle =
      "flex flex-col items-center justify-center w-full p-10 absolute bottom-0";
  }
    ...
    <footer className={containerStyle}>
      <div className="m-2 flex">
        <a
          ...
          href="https://twitter.com/_cassilha_"
        >
          <IoLogoTwitter size={25} />
        </a>
        <a
          className="mr-4 cursor-pointer"
          href="https://www.linkedin.com/in/lucaszawadneak/"
        >
          <IoLogoLinkedin size={25} />
        </a>
        <a
          className="mr-4 cursor-pointer"
          href="https://www.instagram.com/_cassilha"
        >

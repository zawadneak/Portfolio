...
export default function Project({ image, title, description, year, tech, github, web, index }) {
  const variants = {
  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col items-start lg:col-span-3 text-center">
        ...
        <div className="my-2">
          <label className="bg-blue-900 rounded p-1 text-white font-bold text-sm w-14">{year}</label>
          <label className="bg-red-400 rounded p-1 text-white font-bold text-sm w-14 m-2">{tech}</label>
        </div>
